...
public class COSStreamArray extends COSStream {
    ...
    public RandomAccess getScratchFile() {
        ...
        try {
            ScratchFile sf = new ScratchFile(memUsageSetting);
            ra = sf.createBuffer(firstStream.createRawInputStream());
        } catch (IOException ex) {
            Logger.getLogger(COSStreamArray.class.getName()).log(Level.SEVERE, null, ex);
        }
     ...
     * return. - null if no filters are to be applied - a COSName if one filter
     * is to be applied - a COSArray containing COSNames if multiple filters are
     * to be applied
     *
    ...
    /**
     * This will create a new stream for which filtered byte should be written
     * to. You probably don't want this but want to use the
    ...
    public OutputStream createFilteredStream(COSBase expectedLength) throws IOException {
        return firstStream.createOutputStream(expectedLength);
    }
